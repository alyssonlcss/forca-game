/*
    ...
    Discentes.:
        ...
        * Bruno de Andrande Pereira.............| Mª: 493419
        * Felipe Soares do Nascimento...........| Mª: 497182 
        * Paulo Henrique Diniz de Lima Alencar..| Mª: 494837
...
void importar_strings(FILE* arquivo, char* tema[], char path[], int *numero_sorteado) {
    ...
    while(fgets(message, sizeof(message), arquivo) != NULL) {
...
int main(void) {   
    ...
    while(1) {
        ...
        // Porcessamento: realizando a chamada das funções
        switch (escolha){   
